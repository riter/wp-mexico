                        ...
                        <ul>
                            ...
                            foreach($categories as $category) :setup_postdata($category);
                                if(!$category->parent && $category->term_id!=19 && $category->term_id!=22) {  $cant=($cant % 11) + 1 ; ?>
                                    ...
                                    <li ><a href="<?php  echo get_category_link( $category->term_id ) ?>" class="<?php echo "cat-".$category->term_id?>" data-category="<?php echo $category->term_id;?>"><?php echo $category->name ?></a></li>
                            <?php
                                }
                            endforeach;
                            ?>
