    ...
    <footer>
        <div class="foot content">
            ...
            <div class="bottom">
                <div class="left">
                    <ul>
                        <li><a href="<?php echo get_page_link(570)?>" title="Contacto">Contacto</a></li>
                        <li><a href="<?php echo get_page_link(578)?>" title="Publicitate">Publicitate</a></li>
                        <li><a href="<?php echo get_page_link(580)?>" title="Terminos de privacidad">Terminos de privacidad</a></li>
                        <li><a href="<?php echo get_page_link(582)?>" title="Suscribete al boletin">Suscribete al boletin</a></li>
                    </ul>
                </div>
                <div class="right">
                    <?php
