            ...
            <div class="contacto">
                ...
                <div class="box-contacto">
                    <!--<form action="#" method="post">-->
                        ...
                        */
                          echo do_shortcode('[contact-form-7 id="436" title="Formulario de contacto 1"]');
                        ?>
                        <!--<ul>
                            <li>
                            ...
                            <li>
                                <input type="radio" name="enviar_copia" value="enviar_copia" id="enviar_copia" >
                                <label for="enviar_copia">Enviarme una copia</label>
                                </li>
                            <li class="last">
